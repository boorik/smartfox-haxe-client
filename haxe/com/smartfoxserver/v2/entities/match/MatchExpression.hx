...
class MatchExpression
{
	...
	*/
	/** @private */
	internal static function chainedMatchExpression(varName:String, condition:IMatcher, value:Dynamic, logicOp:LogicOperator, parent:MatchExpression):MatchExpression
	{

...
interface Room
{
	 ...
	 */ 
	function get isPasswordProtected():Bool
		
	/** @private */
	function set isPasswordProtected(value:Bool):Void
	
	/** @private */
	function get isManaged():Bool
	...
	/** @private */
	function set isJoined(value:Bool):Void
	
	/** @private */
	function set isGame(value:Bool):Void
		
	/** @private */
	function set isHidden(value:Bool):Void
	
	/** @private */
	function set isManaged(value:Bool):Void

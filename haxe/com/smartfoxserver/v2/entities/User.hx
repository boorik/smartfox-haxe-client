...
interface User
{
	 ...
	 */
	function get_privilegeId():Int;
	
	/** @private */
	function set_privilegeId(value:Int):Void;
	 ...
	 */
	function get_userManager():IUserManager;
	
	/** @private */
	function set_userManager(value:IUserManager):Void;
	 ...
	 */
	function get_aoiEntryPoint():Vec3D;
	
	/** @private */
	function set_aoiEntryPoint(loc:Vec3D):Void;
}
package com.smartfoxserver.v2.entities.match
{
	...
	public class MatchExpression
	{
		...
		*/
		/** @private */
		internal static function chainedMatchExpression(varName:String, condition:IMatcher, value:*, logicOp:LogicOperator, parent:MatchExpression):MatchExpression
		{
		...
		public function asString():String
		{
			...
			sb += "("
			sb += _varName + " " + _condition.symbol + " " + (value is String ? ("'" + value + "'") : value)
			sb += ")"
